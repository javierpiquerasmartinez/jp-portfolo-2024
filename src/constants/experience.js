export const EXPERIENCE = [
  {
    ...
    jobTitle: "BNP Paribas PF - IT Delivery Manager",
    jobDescription:
      "As an IT Delivery Manager, I am responsible for overseeing the end-to-end delivery of IT projects and initiatives, ensuring they are completed on time, within scope, and meet the specified quality standards. My role involves coordinating and collaborating with cross-functional teams, managing resources, and implementing best practices to optimize the delivery process.",
  },
  {
    date: "February 2019 - August 2023",
    jobTitle: "BNP Paribas PF - IT Change Manager",
    jobDescription:
